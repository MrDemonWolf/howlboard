  ...
  return (
    <div className="flex h-screen w-screen">
      ...
      <div className="flex-1 relative">
        ...
        {!isLocalMode && (
          <div className="absolute top-[10px] left-[52px] z-10 hidden md:flex items-center rounded-lg bg-[color:var(--island-bg-color,#232329)] shadow-[0_1px_4px_rgba(0,0,0,0.3)]">
            {/* Sidebar toggle */}
            <button
